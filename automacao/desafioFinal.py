...
def main():
    ...
    grupo_nome = "Squad Orion"
    pesquisar_contato(navegador, grupo_nome)

    resultado_grupo = navegador.find_element(
        By.XPATH, f"//span[@title='{grupo_nome}']")
    resultado_grupo.click()

    sleep(3)

    mensagem = "Teste automatizado de envios de mensagens para o WhatsApp * Squad Orion * Renato, Katie, Ester e Josie!"
