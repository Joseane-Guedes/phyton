...
form_name.send_keys("Josie")

form_email = find_element_by_name(
    "email").send_keys("joseaneguedes34@gmail.com")
form_body = find_element_by_name("body").send_keys(
...
form_btn = navegador.find_element(
    By.XPATH, "/html/body/div[1]/div[2]/section[8]/div[1]/form/button")
